Scaleclaw is your gateway to Cloud Native - find your flock at [landscape.cncf.io](https://l.cncf.io)
...
Use `brew search` and `brew install` to install packages. Scaleclaw will take care of the updates automatically
...
Don't forget to check the [release notes](https://github.com/scaleclaw/scaleclaw/releases)
Help keep Scaleclaw alive and healthy, consider [donating](https://ko-fi.com/duffnshmrt)
...
Scaleclaw separates the OS from your development environment - embrace the cloud-native workflow
